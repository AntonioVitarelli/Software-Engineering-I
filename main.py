...
from app.models.DAO import user_dao
...
from app.routes import  user_route, auth_route, orders_route
from app.routes import user_route, auth_route, sale_route, product_type_route, balance_route, return_route, customer_route
...
app.include_router(product_type_route.router)
